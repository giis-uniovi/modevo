CREATE DATABASE  IF NOT EXISTS `custom` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `custom`;
...
CREATE TABLE `authorbook` (
  ...
  CONSTRAINT `idauthor` FOREIGN KEY (`idauthor`) REFERENCES `author` (`id`),
...
-- Dump completed on 2024-12-16 19:16:55
